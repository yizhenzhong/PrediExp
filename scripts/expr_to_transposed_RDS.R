...
write.table(expression, paste0(RDSout, "_exp.txt"), quote=F, row.names = T, col.names=NA)
write.table(covariate, paste0(RDSout, "_cov.txt"), quote=F, row.names = T, col.names=NA)
