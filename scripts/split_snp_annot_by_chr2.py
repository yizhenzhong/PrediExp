...
def split_genotype(geno_file, out_prefix, snps_dict):
    ...
    with open(geno_file, 'r') as geno:
        ...
        for line in geno:
            ...
            varID_list = line.split()[2]
            
            chr = snps_dict[varID_list]
...
if __name__ == '__main__':
    ...
    anno = sys.argv[3]
    print("get snps from annotation...")
    snps = get_snps(anno)
    print(len(snps.keys()))
    print("split genotype...")
    split_genotype(genotype_file, out_prefix, snps)
